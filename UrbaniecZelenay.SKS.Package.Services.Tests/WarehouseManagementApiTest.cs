...
namespace UrbaniecZelenay.SKS.Package.Services.Tests
{
    ...
    public class WarehouseManagementApiTest
    {
        ...
        {
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.ExportWarehouses())
                .Throws(new BlArgumentException("unit test error"));
            var mockLogger = new Mock<ILogger<WarehouseManagementApiController>>();
            var mapperConfig = new MapperConfiguration(mc => { mc.AddProfile(new MappingsProfileSvcBl()); });
            var controller =
                new WarehouseManagementApiController(mockLogger.Object, mapperConfig.CreateMapper(),
        ...
        [Test]
        public void ExportWarehouse_BlValidationExceptionThrown_ErrorReturned()
        {
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.ExportWarehouses())
                .Throws(new BlValidationException("unit test error"));
            var mockLogger = new Mock<ILogger<WarehouseManagementApiController>>();
            var mapperConfig = new MapperConfiguration(mc => { mc.AddProfile(new MappingsProfileSvcBl()); });
            var controller =
                new WarehouseManagementApiController(mockLogger.Object, mapperConfig.CreateMapper(),
        ...
        [Test]
        public void ExportWarehouse_BlDataNotFoundExceptionThrown_ErrorReturned()
        {
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.ExportWarehouses())
                .Throws(new BlDataNotFoundException("unit test error"));
            var mockLogger = new Mock<ILogger<WarehouseManagementApiController>>();
            var mapperConfig = new MapperConfiguration(mc => { mc.AddProfile(new MappingsProfileSvcBl()); });
            var controller =
                new WarehouseManagementApiController(mockLogger.Object, mapperConfig.CreateMapper(),
        ...
        [Test]
        public void ExportWarehouse_BlRepositoryExceptionThrown_ErrorReturned()
        {
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.ExportWarehouses())
                .Throws(new BlRepositoryException("unit test error"));
            var mockLogger = new Mock<ILogger<WarehouseManagementApiController>>();
            var mapperConfig = new MapperConfiguration(mc => { mc.AddProfile(new MappingsProfileSvcBl()); });
            var controller =
                new WarehouseManagementApiController(mockLogger.Object, mapperConfig.CreateMapper(),
        ...
        [Test]
        public void GetWarehouse_BlValidationExceptionThrown_ErrorReturned()
        {
            string code = null;
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.GetWarehouse(It.Is<string>(s => s == null)))
        ...
        [Test]
        public void GetWarehouse_BlDataNotFoundExceptionThrown_ErrorReturned()
        {
            string code = null;
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.GetWarehouse(It.Is<string>(s => s == null)))
        ...
        [Test]
        public void GetWarehouse_BlRepositoryExceptionThrown_ErrorReturned()
        {
            string code = null;
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.GetWarehouse(It.Is<string>(s => s == null)))
        ...
        [Test]
        public void ImportWarehouses_BlValidationExceptionThrown_ErrorReturned()
        {
            Warehouse validWarehouse = null;
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.ImportWarehouses(It.Is<BlWarehouse>(w => w == null)))
        ...
        [Test]
        public void ImportWarehouses_BlDataNotFoundExceptionThrown_ErrorReturned()
        {
            Warehouse validWarehouse = null;
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.ImportWarehouses(It.Is<BlWarehouse>(w => w == null)))
        ...
        [Test]
        public void ImportWarehouses_BlRepositoryExceptionThrown_ErrorReturned()
        {
            Warehouse validWarehouse = null;
            Mock<IWarehouseManagementLogic> mockWarehouseManagementLogic = new Mock<IWarehouseManagementLogic>();
            mockWarehouseManagementLogic.Setup(m => m.ImportWarehouses(It.Is<BlWarehouse>(w => w == null)))
