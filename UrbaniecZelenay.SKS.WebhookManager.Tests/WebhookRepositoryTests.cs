    ...
    public class WebhookRepositoryTests
    {
        ...
        private class SqlExceptionCreator
        {
            ...
            internal static SqlException NewSqlException(int number = 1)
            {
                ...
                SqlError error = Construct<SqlError>(number, (byte)2, (byte)3, "server name", "error message", "proc",
                    100, null);
        ...
        [Test]
        public void Delete_ValidId_VoidReturned()
        {
            const long id = 1;
            const string url = "https://webhook.site/5a1d1232-ee26-418e-96cb-072a0add7804";
            var validWebhook = new Webhook
            ...
            Assert.DoesNotThrow(() => webhookRepository.Delete(id));
        }

        [Test]
        public void Delete_DbProblemSqlException_ThrowsDalConnectionException()
        {
            const long id = 1;
            var myDbMoq = new Mock<IParcelLogisticsContext>();
            myDbMoq.Setup(m => m.Webhooks).Throws(SqlExceptionCreator.NewSqlException());
            ...
            Assert.Throws<DalConnectionException>(() => webhookRepository.Delete(id));
        }

        [Test]
        public void Delete_DbProblemInvalidOperationException_ThrowsDalConnectionException()
        {
            const long id = 1;
            var myDbMoq = new Mock<IParcelLogisticsContext>();
            myDbMoq.Setup(m => m.Webhooks).Throws(new InvalidOperationException());
        ...
        [Test]
        public void Delete_DbProblemDbUpdateConcurrencyException_ThrowsDalConnectionException()
        {
            const long id = 1;
            var myDbMoq = new Mock<IParcelLogisticsContext>();
            myDbMoq.Setup(m => m.Webhooks).Throws(new DbUpdateConcurrencyException());
            Mock<DatabaseFacade> dbFacadeMock = new(new Mock<DbContext>().Object);
            Mock<IDbContextTransaction> dbTransactionMock = new();
            dbFacadeMock.Setup(m => m.BeginTransaction()).Returns(dbTransactionMock.Object);
            myDbMoq.Setup(m => m.Database).Returns(dbFacadeMock.Object);
        ...
        [Test]
        public void DeleteAll_ValidTrackingId_VoidReturned()
        {
            const string trackingId = "000000001";
            const string url = "https://webhook.site/5a1d1232-ee26-418e-96cb-072a0add7804";
            var validWebhook = new Webhook
            ...
            Assert.DoesNotThrow(() => webhookRepository.DeleteAll(trackingId));
        }

        [Test]
        public void DeleteAll_DbProblemSqlException_ThrowsDalConnectionException()
        {
            const string trackingId = "000000001";
            const string url = "https://webhook.site/5a1d1232-ee26-418e-96cb-072a0add7804";
            var validWebhook = new Webhook
            ...
            var myDbMoq = new Mock<IParcelLogisticsContext>();
            myDbMoq.SetupSequence(m => m.Webhooks)
                .Returns(ParcelLogisticsContextMock.GetQueryableMockDbSet<Webhook>(
                    new List<Webhook> { validWebhook }
                ))
            ...
            Assert.Throws<DalConnectionException>(() => webhookRepository.DeleteAll(trackingId));
        }

        [Test]
        public void DeleteAll_DbProblemInvalidOperationException_ThrowsDalConnectionException()
        {
            const string trackingId = "000000001";
            const string url = "https://webhook.site/5a1d1232-ee26-418e-96cb-072a0add7804";
            var validWebhook = new Webhook
        ...
        [Test]
        public void DeleteAll_DbProblemDbUpdateConcurrencyException_ThrowsDalConnectionException()
        {
            const string trackingId = "000000001";
            const string url = "https://webhook.site/5a1d1232-ee26-418e-96cb-072a0add7804";
            var validWebhook = new Webhook
